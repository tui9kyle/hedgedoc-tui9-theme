...
const options = {
  ...
  item: `<li class="col-xs-12">
          <span class="id" style="display:none;"></span>
          <a href="#">
      
        
            <div class="item" style="min-height: 0px; padding-left: 0px">
              ...
              <div class="col-xs-12 col-md-9" style="text-align: start; padding : 0;">
              <p class="tags" style="padding-left: 30px; margin-bottom: 0px;"></p>
              <h2 class="text" style="margin: 2px 2px 2px 10px; font-size: 2rem; font-weight: bold;"></h2>
              
             
              
              </div>
              <div class="col-xs-12 col-md-3" style="font-size: 1.2rem;">
